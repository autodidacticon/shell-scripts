...
rm -rf packages; git clone git@$GITHUB_DOMAIN:$GITHUB_USER/packages
rm -rf dotfiles; git clone git@$GITHUB_DOMAIN:$GITHUB_USER/dotfiles
rm -rf ohmyzsh; git clone git@$GITHUB_DOMAIN:$GITHUB_USER/ohmyzsh
